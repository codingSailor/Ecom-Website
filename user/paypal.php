...
<form action="<?php echo $paypal_url;?>/cgi-bin/webscr" method="post" name="buyCredits" id="buyCredits">
    ...
    <input type="hidden" name="business" value="akshaybadhe@gmail.com">
    ...
    <input type="hidden" name="return" value="http://localhost/kings Dairy_Project/user/payment_success.php?id=<?php echo $order_id; ?>">
</form>
